...
/**
 * 22px Google 4-color 'G' logo SVG string.
 */
export const GOOGLE_G_LOGO_SVG =
  '<svg class="publisher-logo" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" focusable="false">' +
